...
import { FaRegPaperPlane, FaInstagram, FaYoutube, FaTwitter } from 'react-icons/fa6'
            ...
            <div className='container mx-auto max-w-[1320px]'>
                <div className='grid grid-cols-1 m-10 md:m-0 md:grid-cols-2'>
                    <div>
                        ...
                        <p className='text-white my-10'>Copyright © 2020 Nexcent ltd. <br />All rights reserved</p>

                        <ul className='flex md:flex-row mb-5'>
